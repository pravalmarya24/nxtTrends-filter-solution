...
class AllProductsSection extends Component {
  ...
  getProducts = async () => {
    ...
    const {activeCategoryId, activeRatingId, searchResult} = this.state

    // TODO: Update the code to get products with filters applied

    const {activeOptionId} = this.state
    const apiUrl = `https://apis.ccbp.in/products?sort_by=${activeOptionId}&category=${activeCategoryId}&rating=${activeRatingId}&title_search=${searchResult}`
    const options = {
      headers: {
  ...
  filteringTheCategory = id => {
    this.setState({activeCategoryId: id}, this.getProducts)
    console.log(id)
  }

  filterTheRatingList = ratingId => {
  ...
  filterBySearchElement = val => {
    this.setState({searchResult: val}, this.getProducts)
  }
